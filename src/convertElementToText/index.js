const heartPath = (classes, left, right, rotate) => {
    return `
    <svg class="${classes}" data-e2e="" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" style="--rotate: ${rotate}deg; left: ${left}; top: ${right};">
...
const textElemts = { heartPath };

export default textElemts;
